...
# CONFIG
# ===============================
INPUT_VIDEO = "7048957-sd_426_240_30fps.mp4"
OUTPUT_1080P = "7048957-sd_1080p.mp4"
OUTPUT_4K = "7048957-sd_4k.mp4"
...
if USE_GPU:
    try:
        ...
        print("[ERROR] RealESRGAN package not found. Run: pip install git+https://github.com/ai-forever/Real-ESRGAN.git")
        exit(1)
